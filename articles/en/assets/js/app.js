...
const KANZ_CONFIG = {
  ...
  aiSummaryEndpoint: '/articles/en/api/summary',
  dataPath: '/articles/en/data/content.json'
};
...
async function loadArchives() {
  ...
  while (i <= MAX_ARCHIVES) {
    try {
      const r = await fetch(`/articles/en/data/archive_${i}.json`);
      ...
      <div class="site-footer-brand">
        <div class="site-footer-logo">
          <div class="site-footer-logo-img">
            <img src="/articles/en/assets/icons/icon-192.png" width="48" height="48" loading="lazy"
...
function registerSW() {
  ...
  navigator.serviceWorker.register('/articles/en/sw.js', { scope: '/articles/en/' }).then(reg => {
